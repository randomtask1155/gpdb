...
def install_system_deps():
    status = subprocess.call(["yum", "--exclude=systemtap", "groupinstall", "-y", "Development tools"])
    if status:
        return status
    ...
    status = subprocess.call(["pip", "install", "psi", "lockfile", "paramiko", "setuptools", "epydoc"])
    return status
